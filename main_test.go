...
func setupTestApp() (*fiber.App, *ItemStorage) {
	app := fiber.New()
	storage := &ItemStorage{
...
func TestCreateItem(t *testing.T) {
	...
	reqBody := CreateItemRequest{Name: "Test Item"}
...
func TestCreateItemEmptyName(t *testing.T) {
	...
	reqBody := CreateItemRequest{Name: ""}
	body, _ := json.Marshal(reqBody)
...
func TestListItems(t *testing.T) {
	...
	storage.Create(Item{Name: "Item 1"})
	storage.Create(Item{Name: "Item 2"})
...
func TestGetItem(t *testing.T) {
	...
	id, _ := storage.Create(Item{Name: "Test Item"})
...
func TestUpdateItemName(t *testing.T) {
	...
	id, _ := storage.Create(Item{Name: "Old Name"})

	newName := "New Name"
	reqBody := UpdateItemRequest{Name: &newName}
	body, _ := json.Marshal(reqBody)
...
func TestUpdateItemChecked(t *testing.T) {
	...
	checked := true
	reqBody := UpdateItemRequest{Checked: &checked}
	body, _ := json.Marshal(reqBody)
